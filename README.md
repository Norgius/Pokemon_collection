...
Сделайте миграцию и запустите разработческий сервер
...
```
Перейдите по адресу `127.0.0.1:8000` в вашем браузере.
...
## Как работать с базой данных проекта
Создайте суперпользователя, в процессе создания введите имя, почту и пароль:
```
python3 manage.py createsuperuser
```
Далее по адресу: `127.0.0.1:8000/admin` введите имя и пароль.

Уже будучи на сайте можете добавлять покемонов и их сущности
```
Pokemons
Pokemon entitys
```
